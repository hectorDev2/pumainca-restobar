      ...
      <nav className="sticky top-0 z-50 w-full border-b border-earth-700/30 bg-earth-950/95 backdrop-blur-md transition-all duration-300">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-10 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4 md:gap-8">
            ...
            {showSearch && (
              <div
                className="hidden md:flex relative w-60 lg:w-80"
                    ...
                    {isLoading ? (
                      ...
                      <div className="max-h-80 overflow-y-auto">
                        {searchResults.slice(0, 5).map((product) => (
                          ...
                          >
                            <div
                              className="size-10 rounded-lg bg-surface-dark bg-cover bg-center shrink-0"
                              style={{
          ...
          <div className="flex items-center gap-3 sm:gap-4 md:gap-8">
            <div className="hidden lg:flex items-center gap-8">
              ...
              <Link href="/reservas" className={isActive("/reservas")}>
                Reservas
              </Link>
            </div>
            ...
            <div className="flex gap-2 sm:gap-3">
              ...
              >
                <span className="material-symbols-outlined text-text-primary text-lg sm:text-xl">
                  shopping_cart
                </span>
                {cartCount > 0 && (
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex flex-col px-2">
                    ...
                    <p className="text-honey/70 text-xs">
                  ...
                  <div className="space-y-3 px-4">
                    {["Vegetariano", "Vegano", "Sin Gluten"].map((label) => (
                      ...
                      >
                        ...
                        />
                        <span className="text-honey text-sm font-medium group-hover:text-cream transition-colors">
                          {label}
                        </span>
                      </label>
                    ))}
