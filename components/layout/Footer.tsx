    ...
    <footer className="bg-black border-t border-zinc-900 pt-16 pb-8">
      <div className="max-w-[1280px] mx-auto px-6 sm:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Links */}
          <div>
            <h4 className="text-primary font-bold mb-6 text-xs uppercase tracking-[0.2em]">
              Explorar
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-zinc-500 text-sm whitespace-pre-line">
        ...
        <div className="border-t border-zinc-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <button className="text-zinc-600 hover:text-white text-xs transition-colors">
              Privacidad
            </button>
            <button className="text-zinc-600 hover:text-white text-xs transition-colors">
              Términos
