...
const HomeScreen: React.FC<Props> = ({ onNavigate, cartCount }) => {
  return (
    <div className="flex flex-col min-h-screen">
      <Navbar onNavigate={onNavigate} cartCount={cartCount} activeScreen="home" />
        ...
        <div className="container max-w-[1100px] mx-auto px-4 space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16" id="historia">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-gray-600 dark:text-text-secondary text-lg leading-relaxed">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16" id="filosofia">
            <div className="flex-1 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3 bg-gray-50 dark:bg-surface-dark p-4 rounded-xl border border-gray-200 dark:border-border-dark">
                  <span className="material-symbols-outlined text-primary">eco</span>
                  <span className="text-sm font-semibold text-gray-800 dark:text-gray-200">100% Orgánico</span>
                </div>
                <div className="flex items-center gap-3 bg-gray-50 dark:bg-surface-dark p-4 rounded-xl border border-gray-200 dark:border-border-dark">
                  <span className="material-symbols-outlined text-primary">handshake</span>
                  <span className="text-sm font-semibold text-gray-800 dark:text-gray-200">Comercio Justo</span>
                </div>
              </div>
            </div>
            <div className="flex-1 w-full aspect-video rounded-2xl overflow-hidden shadow-2xl relative group">
      ...
      <section className="py-24 bg-surface-dark relative overflow-hidden text-center">
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <button 
            onClick={() => onNavigate('menu')}
            className="bg-primary hover:bg-primary-dark text-white text-lg font-bold px-12 py-4 rounded-full shadow-2xl shadow-red-600/20 transform hover:scale-105 transition-all">
            Hacer mi Pedido
          </button>
        </div>
      </section>
