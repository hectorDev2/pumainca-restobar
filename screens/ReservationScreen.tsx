...
const ReservationScreen: React.FC<Props> = ({ onNavigate, cartCount }) => {
  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-background-light dark:bg-background-dark">
        <Navbar onNavigate={onNavigate} cartCount={cartCount} activeScreen="reservas" />
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark">
      ...
      <div className="max-w-lg mx-auto px-4 sm:px-8">
        ...
        <form onSubmit={handleSubmit} className="bg-surface-light dark:bg-surface-dark p-8 rounded-3xl shadow-xl border border-zinc-200 dark:border-zinc-800 space-y-5">
