...
const CartScreen: React.FC<Props> = ({ cart, totals, onNavigate, onRemove, onUpdateQty }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background-dark">
      <Navbar onNavigate={onNavigate} cartCount={cart.length} />
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            {cart.length > 0 ? (
                ...
                <div className="mt-12 pt-8 border-t border-zinc-800">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {upsellDishes.map(d => {
                        ...
                        return (
                          <div key={d.id} className="bg-surface-dark rounded-xl p-3 border border-zinc-800 hover:border-primary/50 transition-all cursor-pointer group" onClick={() => onNavigate('dish-detail', d.id)}>
              ...
              <div className="py-20 text-center space-y-6">
                ...
                <button onClick={() => onNavigate('menu')} className="bg-primary hover:bg-red-500 text-white px-8 py-3 rounded-xl font-bold transition-all">
                  Explorar Menú
                </button>
              </div>
            )}
            ...
            <div className="sticky top-24 space-y-4">
              <div className="bg-surface-dark border border-zinc-800 rounded-2xl p-6 shadow-2xl">
                ...
                <button 
                  ...
                  className="w-full bg-primary hover:bg-red-500 disabled:opacity-50 disabled:hover:bg-primary text-white font-bold text-lg rounded-xl py-4 flex items-center justify-center gap-2 transition-transform active:scale-95 shadow-xl shadow-primary/20">
                  Proceder al Pago
